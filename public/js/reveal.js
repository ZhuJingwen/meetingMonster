...
(function( root, factory ) {
	...
	function setupDOM() {
		...
		createSingletonNode( dom.wrapper, 'aside', 'controls',
			'<div class="navigate-left"><img src ="svg/prev.svg" width = 48px> </div>' +
			'<div class="navigate-right"><img src ="svg/next.svg" width = 48px> </img></div> '  );
		...
		if( dom.wrapper && !isPrintingPDF() ) {
			...
			if( scale === 1 ) {
				...
				// Apply scale transform as a fallback
					...
					dom.slides.style.width = '100%';
					dom.slides.style.height = '100%';
				}
			}
